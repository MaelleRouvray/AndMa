...
3/ env.agent_iter(): ????????????? env.step(action): on met une pièce à la position souhaitée (action) sur board 4/ env.last () renvoie : observation, reward, termination, truncation, info 5/
